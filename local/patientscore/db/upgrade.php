...
function xmldb_local_patientscore_upgrade($oldversion) {
    global $CFG,$DB;

    $dbman = $DB->get_manager();
         if ($oldversion < 2017070120) {
        ...
        $field3 = new xmldb_field('pcity', XMLDB_TYPE_CHAR, '256', null, XMLDB_NOTNULL, null, null, 'paadharnumber');
        $field4 = new xmldb_field('timemodified', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, '0', 'pcity');
        $field5 = new xmldb_field('status', XMLDB_TYPE_CHAR, '5', null, XMLDB_NOTNULL, null, null, 'patient_id');
        ...
        upgrade_plugin_savepoint(true, 2017070120,'local', 'patientscore');
    }
