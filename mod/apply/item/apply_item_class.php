...
abstract class apply_item_base
{
    ...
    abstract public function build_editform($item, $apply, $cm);
     ...
     * @param object $item the db-object from apply_item
    ...
    /**
     * @param object $item the db-object from apply_item
     * @param string $value a item-related value from apply_values
     * @return string
     */
