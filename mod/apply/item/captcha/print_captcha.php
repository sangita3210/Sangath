...
$PAGE->set_url('/mod/apply/item/captcha/print_captcha.php', array('id'=>$id));
...
$height = 40;
$charcount = $SESSION->apply->item->captcha->charcount;
...
$SESSION->apply->item->captcha->checkchar = $checkchar;
