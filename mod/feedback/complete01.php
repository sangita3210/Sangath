...
//$PAGE->set_title("aaaaaaaaaaaaaaa");
...
if (!$feedbackcompletion->is_open()) {
   ...
   // echo $OUTPUT->heading(format_string("aaaaaaaaa"));
...
if ($feedbackcompletion->is_empty()) {
    ...
    if ($feedbackcompletion->just_completed()) {
        ...
        // change by me...........
       $feeddata = $feedback->site_after_submit;
       print_object($feeddata);
       $compid = $feeddata->id;
       $patientdetails = $DB->get_record('patient_complete_details',array('id' =>$compid));
       print_object($patientdetails);
       $patientid = $patientdetails->patient_id;
       print_object($patientid);
       // echo $OUTPUT->heading(format_string($patientdetails->patient_id));
        echo $OUTPUT->continue_button($url);
    } else {
        print_object("hello555");
        // Display the form with the questions.
        echo $feedbackcompletion->render_items();
    }
} else {
    print_object("heloo hiii bye bye");
    echo $OUTPUT->box_start('generalbox boxaligncenter');
