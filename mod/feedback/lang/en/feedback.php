...
$string['completed_feedbacks'] = 'submitted Answer';
...
/// Language Add by Sangita

$string['scoring'] = 'Scoring ';
$string['Subscale'] = 'Subscale';
$string['Inter'] = 'Internalising score';
$string['Exter'] = 'Externalising score';
$string['Total'] = 'Total difficulties score';
$string['Sum1'] = 'Sum of the emotional and peer problems scales';
$string['Sum2'] = 'Sum of the conduct and hyperactivity scales';
$string['Sum3'] = 'Sum of all the scales except the prosocial scale';
$string['Score'] = 'Score';
