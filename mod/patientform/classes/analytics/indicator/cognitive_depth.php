...
/**
 * Cognitive depth indicator - patientform.
 *
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_patientform');
    }
    ...
    public function get_cognitive_depth_level(\cm_info $cm) {
        ...
        if (!empty($this->instancedata[$cm->instance]->publish_stats)) {
            // If stats are published we count that the user viewed patientform.
