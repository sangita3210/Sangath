...
/**
 * The mod_patientform course module viewed event.
 *
...
/**
 * The mod_patientform course module viewed event class.
 *
...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'patientform';
    }

    /**
     * Creates an instance from patientform record
     *
     ...
     */
    public static function create_from_record($patientform, $cm, $course) {
        $event = self::create(array(
            'objectid' => $patientform->id,
            'context' => \context_module::instance($cm->id),
            'anonymous' => ($patientform->anonymous == PATIENTFORM_ANONYMOUS_YES),
            'other' => array(
                'anonymous' => $patientform->anonymous // Deprecated.
            )
        ));
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'patientform', 'restore' => 'patientform');
    }
