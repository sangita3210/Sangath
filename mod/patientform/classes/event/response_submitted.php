...
/**
 * The mod_patientform response submitted event.
 *
...
/**
 * The mod_patientform response submitted event class.
 *
 * This event is triggered when a patientform response is submitted.
 *
...
class response_submitted extends \core\event\base {
    ...
    public static function create_from_record($completed, $cm) {
        $event = self::create(array(
            ...
            'other' => array(
                'cmid' => $cm->id,
                'instanceid' => $completed->patientform,
    ...
    public static function get_name() {
        return get_string('eventresponsesubmitted', 'mod_patientform');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' submitted response for 'patientform' activity with "
    ...
    public function get_url() {
        if ($this->anonymous) {
            return new \moodle_url('/mod/patientform/show_entries.php', array('id' => $this->other['cmid'],
    ...
    protected function get_legacy_logdata() {
        if ($this->anonymous) {
            ...
            return array($this->courseid, 'patientform', 'submit', 'view.php?id=' . $this->other['cmid'],
