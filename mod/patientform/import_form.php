...
class patientform_import_form extends moodleform {
    public function definition() {
        global $CFG;
        $mform =& $this->_form;

        $strdeleteolditmes = get_string('delete_old_items', 'patientform').
                             ' ('.get_string('oldvalueswillbedeleted', 'patientform').')';

        $strnodeleteolditmes = get_string('append_new_items', 'patientform').
                               ' ('.get_string('oldvaluespreserved', 'patientform').')';
