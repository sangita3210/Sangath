...
$PAGE->set_url('/mod/patientform/item/captcha/print_captcha.php', array('id'=>$id));
...
if (!isset($SESSION->patientform->item->captcha)) {
    print_error('captchanotset', 'patientform');
}

$height = 40;
$charcount = $SESSION->patientform->item->captcha->charcount;
...
$SESSION->patientform->item->captcha->checkchar = $checkchar;
