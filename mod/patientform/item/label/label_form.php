...
class patientform_label_form extends patientform_item_form {
    ...
    public function definition() {
        ...
        $mform->addElement('editor', 'presentation_editor', get_string('labelcontents', 'patientform'), null, $presentationoptions);
