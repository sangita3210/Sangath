...
class patientform_multichoicerated_form extends patientform_item_form {
    ...
    public function definition() {
        ...
        $mform->addElement('text',
                            ...
                            array('size'=>PATIENTFORM_ITEM_LABEL_TEXTBOX_SIZE,
                                  'maxlength'=>255));
        ...
        $this->values = $mform->addElement('textarea',
                            'values',
                            get_string('multichoice_values', 'patientform'),
                            'wrap="virtual" rows="10" cols="65"');

        $mform->addElement('static',
                            'hint',
                            '',
                            get_string('use_one_line_for_each_value', 'patientform'));
    ...
    public function get_data() {
        ...
        $item->presentation = $subtype.PATIENTFORM_MULTICHOICERATED_TYPE_SEP.$presentation;
