@mod @mod_patientform
Feature: Anonymous patientform
  In order to collect patientforms
  As an admin
  I need to be able to allow anonymous patientforms
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | patientform   | Site patientform   | Acceptance test site | patientform0 | 1         | 1             | 1       |
      | patientform   | Course patientform | C1                   | patientform1 | 1         | 1             | 0       |
  ...
  Scenario: Guests can see anonymous patientform on front page but can not complete
    When I follow "Site patientform"
    Then I should not see "Answer the questions..."
    And I follow "Preview"
    And I should see "Do you like our site?"
    And I press "Continue"

  Scenario: Complete anonymous patientform on the front page as an authenticated user
  ...
  @javascript
  Scenario: Complete anonymous patientform and view analysis on the front page as an authenticated user
    And I log in as "admin"
    And I set the following system permissions of "Authenticated user on frontpage" role:
      | capability                   | permission |
      | mod/patientform:viewanalysepage | Allow      |
    And I log out
    And I log in as "user1"
    And I am on site homepage
    When I follow "Site patientform"
    ...
    # And I should not see "multichoice2" # TODO MDL-29303 do not show labels to users who can not edit patientform
  ...
  Scenario: Complete fully anonymous patientform on the front page as a guest
    And I log in as "admin"
    And I set the following administration settings values:
      | patientform_allowfullanonymous | 1 |
    And I log out
    When I follow "Site patientform"
    And I follow "Preview"
    And I should see "Do you like our site?"
  ...
  @javascript
  Scenario: Complete fully anonymous patientform and view analyze on the front page as a guest
    And I log in as "admin"
    And I set the following administration settings values:
      | patientform_allowfullanonymous | 1 |
  ...
  @javascript
  Scenario: Anonymous patientform in a course
    # Teacher can not
  ...
  Scenario: Collecting new non-anonymous patientform from a previously anonymous patientform activity
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Course patientform"
    ...
    And I press "Save and display"
    And I log out
    # Now leave a non-anon patientform as user1
    When I log in as "user1"
    And I am on "Course 1" course homepage
    And I follow "Course patientform"
    And I follow "Answer the questions..."
