@mod @mod_patientform
Feature: Mapping courses in a patientform
  In order to collect the same patientform about multiple courses
  As a manager
  I need to be able to map site patientform to courses
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | patientform   | Course patientform  | Acceptance test site | patientform0 | 1         | 1             | 1       |
      | patientform   | Another patientform | C1                   | patientform1 | 1         | 1             | 0       |
    When I log in as "manager"
    And I am on site homepage
    And I follow "Course patientform"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I add a "Information" question to the patientform with:
      | Question         | this is an information question |
      | Label            | info                            |
      | Information type | Course                          |
    And I add a "Multiple choice (rated)" question to the patientform with:
      | Question               | this is a multiple choice rated    |
      | Label                  | multichoicerated                   |
      | Multiple choice type   | Multiple choice - single answer    |
      | Multiple choice values | 0/option a\n1/option b\n5/option c |
    And I add a "Multiple choice" question to the patientform with:
    ...
    And I add the "patientform" block
  ...
  Scenario: Course patientform can not be mapped
    And I log in as "manager"
    And I am on "Course 1" course homepage
    And I follow "Another patientform"
    And I should not see "Mapped courses"
    And I should not see "Map patientform to courses"

  @javascript
  Scenario: Site patientform is not mapped to any course
    And I log in as "user1"
    And I am on site homepage
    And I follow "Course patientform"
    And I follow "Answer the questions..."
    And I should see "Acceptance test site" in the ".patientform_form" "css_element"
    ...
    And I am on "Course 1" course homepage
    And I click on "Course patientform" "link" in the "patientform" "block"
    And I follow "Answer the questions..."
    And I should not see "Acceptance test site" in the ".patientform_form" "css_element"
    And I should see "C1" in the ".patientform_form" "css_element"
    And I set the following fields to these values:
      | option b                         | 1        |
    ...
    And I should see "All courses" in the "#patientform_course_filter [data-fieldtype=autocomplete] .form-autocomplete-selection [role=listitem]" "css_element"
    And I show chart data for the "multichoicerated" patientform
    ...
    And I press "Filter"
    And I should see "Course 1" in the "#patientform_course_filter [data-fieldtype=autocomplete] .form-autocomplete-selection [role=listitem]" "css_element"
    And I show chart data for the "multichoicerated" patientform
  ...
  @javascript
  Scenario: Site patientform is mapped to courses
    And I log in as "manager"
    And I am on site homepage
    And I follow "Course patientform"
    And I follow "Map patientform to courses"
    ...
    And I am on site homepage
    And I follow "Course patientform"
    And I should see "You can only access this patientform from a course"
    And I should not see "Answer the questions..."

    And I am on "Course 1" course homepage
    And "Patientform" "block" should not exist
    And I should not see "Course patientform"

    And I am on "Course 2" course homepage
    And I click on "Course patientform" "link" in the "Patientform" "block"
    And I follow "Answer the questions..."
    And I should not see "Acceptance test site" in the ".patientform_form" "css_element"
    And I should see "C2" in the ".patientform_form" "css_element"
    And I set the following fields to these values:
      | option b                         | 1        |
      | this is a simple multiple choice | option e |
    And I press "Submit your answers"
    ...
    And I follow "Answer the questions..."
    And I should not see "Acceptance test site" in the ".patientform_form" "css_element"
    And I should see "C3" in the ".patientform_form" "css_element"
    And I set the following fields to these values:
      | option c                         | 1        |
      | this is a simple multiple choice | option d |
    And I press "Submit your answers"
    ...
    And I should see "1 (50.00 %)" in the "option b" "table_row"
    And I should see "1 (50.00 %)" in the "option c" "table_row"
    And I show chart data for the "multichoicesimple" patientform
  ...
  Scenario: Site patientform deletion hides patientform block completely
    When I log in as "manager"
    And I am on site homepage
    And I turn editing mode on
    And I add the "patientform" block
    And I add the "Main menu" block
    And I click on "Delete" "link" in the "Course patientform" activity
    And I press "Yes"
    And I follow "Turn editing off"
    And I am on site homepage
    Then "patientform" "block" should not exist
    And I am on "Course 1" course homepage
    And "patientform" "block" should not exist
    And I log out
