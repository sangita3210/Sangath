@mod @mod_patientform
Feature: Exporting and importing patientforms
  In order to quickly copy patientforms across courses and sites
  As a teacher
  I need to be able to export and import patientforms
  ...
  Scenario: Export sample patientform and compare with the fixture
    ...
    Then following "Export questions" should export patientform identical to "mod/patientform/tests/fixtures/testexport.xml"
    And I log out

  @javascript @_file_upload
  Scenario: Import patientform deleting old items
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Learning experience"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    ...
    And I upload "mod/patientform/tests/fixtures/testexport.xml" file to "File" filemanager
    And I press "Yes"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
  ...
  @javascript @_file_upload
  Scenario: Import patientform appending new items
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Learning experience"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
