@mod @mod_patientform
Feature: patientforms in courses with groups
  In order to collect patientforms per group
  As an teacher
  I need to be able to filter patientform replies by groups
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | patientform   | Site patientform   | Acceptance test site | patientform0 | 2         | 1             | 1         | 1       |
      | patientform   | Course patientform | C1                   | patientform1 | 2         | 1             | 1         | 0       |
      | patientform   | Course anon patientform | C1              | patientform2 | 1         | 1             | 1         | 0       |
    When I log in as "manager"
    And I am on site homepage
    And I follow "Site patientform"
  ...
  @javascript
  Scenario: Non anonymous patientform with groups in a course
    ...
    And I add a "Multiple choice" question to the patientform with:
      ...
      | Multiple choice values         | Yes of course\nNot at all\nI don't know |
    And I log out
    And I log in as "user1" and complete patientform "Course patientform" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user2" and complete patientform "Course patientform" in course "Course 1" with:
      | I don't know | 1 |
    And I log in as "user3" and complete patientform "Course patientform" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user4" and complete patientform "Course patientform" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user5" and complete patientform "Course patientform" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user6" and complete patientform "Course patientform" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user7" and complete patientform "Course patientform" in course "Course 1" with:
      | I don't know | 1 |
    ...
    And I show chart data for the "multichoice1" patientform
  ...
  @javascript
  Scenario: Anonymous patientform with groups in a course
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Course anon patientform"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I add a "Multiple choice" question to the patientform with:
      | Question                       | Do you like this course?           |
      | Label                          | multichoice1                       |
      ...
      | Multiple choice values         | Yes of course\nNot at all\nI don't know |
    And I log out
    And I log in as "user1" and complete patientform "Course anon patientform" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user1"
    And I am on "Course 1" course homepage
    And I follow "Course anon patientform"
    ...
    And I log out
    And I log in as "user2" and complete patientform "Course anon patientform" in course "Course 1" with:
      | I don't know | 1 |
    And I log in as "user3" and complete patientform "Course anon patientform" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user4" and complete patientform "Course anon patientform" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user5" and complete patientform "Course anon patientform" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user6" and complete patientform "Course anon patientform" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user7" and complete patientform "Course anon patientform" in course "Course 1" with:
      | I don't know | 1 |
    # View analysis, user1 should only see one group - group 1
    And I log in as "user1"
    And I am on "Course 1" course homepage
