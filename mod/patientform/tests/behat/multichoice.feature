@mod @mod_patientform
Feature: Testing multichoice questions in patientform
  In order to create patientforms
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | patientform   | Learning experience | C1     | patientform0   |
  ...
  @javascript
  Scenario: Non-rated single-answer multiple choice questions in patientform
    When I add a "Multiple choice" question to the patientform with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
      | Multiple choice type | Multiple choice - single answer |
      | Multiple choice values | option a\noption b\noption c  |
    And I add a "Label" question to the patientform with:
      | Contents | this is the first page of the patientform |
    ...
    And I add a "Multiple choice" question to the patientform with:
      ...
      | Required | 1 |
    And I add a "Label" question to the patientform with:
      | Contents | this is the second page of the patientform |
    And I select "Add a page break" from the "Add question" singleselect
    And I add a "Multiple choice" question to the patientform with:
    ...
    And I add a "Label" question to the patientform with:
      | Contents | this is the third page of the patientform |
    And I log out
    ...
    And I should see "this is the first page of the patientform"
    And I should not see "this is the second page of the patientform"
    And I should not see "this is the third page of the patientform"
    ...
    And "Submit your answers" "button" should not exist
    And I should not see "this is the first page of the patientform"
    And I should see "this is the second page of the patientform"
    And I should not see "this is the third page of the patientform"
    And I press "Next page"
    ...
    And I should see "this is the third page of the patientform"
    ...
    And I show chart data for the "multichoice2" patientform
    ...
    And I show chart data for the "multichoice3" patientform
    ...
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I open the action menu in "//div[contains(@class, 'patientform_itemlist') and contains(.,'multichoice1')]" "xpath_element"
  ...
  @javascript
  Scenario: Non-rated multiple-answers multiple choice questions in patientform
    # Create a patientform with three pages, required and dependent questions.
    When I add a "Multiple choice" question to the patientform with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
  ...
  @javascript
  Scenario: Non-rated single-answer dropdown multiple choice questions in patientform
    When I add a "Multiple choice" question to the patientform with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
