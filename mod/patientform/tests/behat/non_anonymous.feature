@mod @mod_patientform
Feature: Non anonymous patientform
  In order to collect patientforms
  As an teacher
  I need to be able to create and collect patientforms
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | patientform   | Site patientform   | Acceptance test site | patientform0 | 2         | 1             | 1       |
      | patientform   | Course patientform | C1                   | patientform1 | 2         | 1             | 0       |
  ...
  Scenario: Guests can see non anonymous patientform on front page but can not complete
  ...
  Scenario: Complete non anonymous patientform on the front page as an authenticated user
  ...
  @javascript
  Scenario: Complete non anonymous patientform and view analysis on the front page as an authenticated user
  ...
  @javascript
  Scenario: Non anonymous patientform in a course
