@mod @mod_patientform
Feature: Test creating different types of patientform questions for anonymous patientform
  In order to create patientforms
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in anonymous patientform with javascript enabled
