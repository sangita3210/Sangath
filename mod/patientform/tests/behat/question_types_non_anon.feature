@mod @mod_patientform
Feature: Test creating different types of patientform questions for non-anonymous patientform
  In order to create patientforms
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in non-anonymous patientform with javascript enabled
    ...
    And the following "activities" exist:
      ...
      | patientform   | Learning experience | C1     | patientform0   | 2         |
    ...
    And I add a "Label" question to the patientform with:
      | Contents | label text |
    And I add a "Longer text answer" question to the patientform with:
    ...
    And I add a "Numeric answer" question to the patientform with:
    ...
    And I follow "Answer the questions..."
    And I set the following fields to these values:
      | this is a longer text answer | lots of patientforms |
      | option a                     | 1              |
      | option d                     | 1              |
      | option e                     | 1              |
    ...
    And I should see "lots of patientforms" in the "(longertext)" "table"
    ...
    And I show chart data for the "multichoice4" patientform
