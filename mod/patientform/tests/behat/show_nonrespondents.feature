@mod @mod_patientform
Feature: Show users who have not responded to the patientform survey
  In order to harass students about completing the patientform
  As a teacher
  ...
  Scenario: See users who have not responded
    # Set up a patientform.
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I add a "patientform" to section "1" and I fill the form with:
      | Name                | Frogs                                             |
      | Description         | x                                                 |
    ...
    # Go in as student 1 and do the patientform.
