@mod @mod_patientform
Feature: Saving, using and deleting patientform templates
  In order to quickly create patientforms
  As a manager
  I need to be able to create patientform templates
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | patientform   | Learning experience course 1 | C1     | patientform1   |
      | patientform   | Another patientform in course 1 | C1     | patientform2   |
      | patientform   | Learning experience course 2 | C2     | patientform3   |
  ...
  Scenario: Teacher can save template and re-use it in the same course only
    # Go to patientform templates and make sure none exist yet
    ...
    # Create a patientform from this template in the same course
    And I am on "Course 1" course homepage
    And I follow "Another patientform in course 1"
    And I follow "Templates"
  ...
  Scenario: Teacher can append template to existing questions or remove them
    # Save patientform as a course template
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Learning experience course 1"
    And I follow "Templates"
    And I set the field "Name" to "My first template"
    And I press "Save as new template"
    # Add questions to another patientform
    And I am on "Course 1" course homepage
    And I follow "Another patientform in course 1"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I add a "Multiple choice" question to the patientform with:
  ...
  Scenario: Teacher can delete course templates but can not delete public templates
    # Save patientform as both public and course template
    When I log in as "manager"
    And I am on "Course 1" course homepage
    And I follow "Learning experience course 1"
    And I follow "Templates"
