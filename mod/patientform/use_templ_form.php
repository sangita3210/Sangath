...
class mod_patientform_use_templ_form extends moodleform {
    public function definition() {
        $mform =& $this->_form;

        // visible elements
        $mform->addElement('radio', 'deleteolditems', '', get_string('delete_old_items', 'patientform'), 1);
        $mform->addElement('radio', 'deleteolditems', '', get_string('append_new_items', 'patientform'), 0);
